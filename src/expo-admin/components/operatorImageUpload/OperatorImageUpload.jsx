...
import styles from './OperatorImageUpload.module.css';
import instance from '../../../api/lib/axios';

const OperatorImageUpload = ({ onUploadSuccess, onUploadError, accept = "image/*", maxSize = 10 * 1024 * 1024, initialImageUrl}) => {
...
export default OperatorImageUpload;
